...
class ConcurrentStrategySpec extends munit.FunSuite {
  ...
  test("CE3 Concurrent matches Parallel (parallel call: ce370shared/Workload.scala:23, concurrent call: ce370shared/Workload.scala:31)") {
  ...
  test("CE3 Concurrent uses start/joinWithNever path (call site: ce370shared/Workload.scala:31)") {
